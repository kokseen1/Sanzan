...
class Audio:
    ...
    def encrypt(self, output, padding=True, out_format=DEFAULT_AUDIO_FORMAT, denoise=False, preview=False):
        """
        ...
        if padding:
            ...
            new_shape = (padded_length, self.audio.channels) if self.audio.channels > 1 else padded_length
            target_array = np.resize(self.array, new_shape)
    ...
    def decrypt(self, output, padding=True, out_format=DEFAULT_AUDIO_FORMAT, denoise=True, preview=False):
        """
